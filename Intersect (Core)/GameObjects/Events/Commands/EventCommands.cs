...
namespace Intersect.GameObjects.Events.Commands
{
    ...
    public class CreateNationCommand : EventCommand
    {
        ...
        public CreateNationCommand(Dictionary<Guid, List<EventCommand>> commandLists)
        {
            for (var i = 0; i < BranchIds.Length; i++)
            {
                BranchIds[i] = Guid.NewGuid();
        ...
        public override EventCommandType Type { get; } = EventCommandType.CreateNation;
    ...
    public class JoinNationCommand : EventCommand
    {

        //For Json Deserialization
        public JoinNationCommand()
        {
        }

        public JoinNationCommand(Dictionary<Guid, List<EventCommand>> commandLists)
        {
            for (var i = 0; i < BranchIds.Length; i++)
            {
                BranchIds[i] = Guid.NewGuid();
        ...
        public override EventCommandType Type { get; } = EventCommandType.JoinNation;
