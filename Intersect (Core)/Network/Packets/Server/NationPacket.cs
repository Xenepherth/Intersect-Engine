...
namespace Intersect.Network.Packets.Server
{
    ...
    /// <summary>
    /// The definition of the GuildPacket sent to a player containing the online and offline members of their nations.
    /// </summary>
    [MessagePackObject]
    public class NationPacket : IntersectPacket
    {
        /// <summary>
